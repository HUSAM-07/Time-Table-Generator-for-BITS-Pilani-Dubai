...
class Data:
    ...
    def __init__(self, groups=None, teachers=None, classes=None, classrooms=None):
        self.groups = groups
    ...
    def load_data(self, file_path, teachers_empty_space, groups_empty_space, subjects_order):
        ...
        for cl in data['Casovi']:
            ...
            for group in new_group:
                if group not in self.groups:
                    ...
                    groups_empty_space[self.groups[group]] = []

            # add teacher
            if new_teacher not in self.teachers:
                self.teachers[new_teacher] = len(self.teachers)
        ...
        for cl in class_list:
            self.classes[len(self.classes)] = cl
        ...
        for type in data['Ucionice']:
            for name in data['Ucionice'][type]:
                ...
                self.classrooms[len(self.classrooms)] = new
        ...
        for i in self.classes:
            ...
            index_classrooms = []
            # add classrooms
            for index, c in self.classrooms.items():
                if c.type == classroom:
